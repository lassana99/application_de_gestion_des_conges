...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">La liste des employées</h3>
		<div class="card-tools">
			<a href="?page=employees/manage_employee" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Créer un nouvel employé</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td >
								<p class="m-0 ">
									<b>Département: </b><?php echo isset($dept_arr[$row['department_id']]) ? $dept_arr[$row['department_id']] : 'N/A' ?><br>
									<b>Désignation: </b><?php echo isset($desg_arr[$row['designation_id']]) ? $desg_arr[$row['designation_id']] : 'N/A' ?><br>
								</p>
							</td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <a class="dropdown-item" href="?page=employees/manage_employee&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Modifier</a>
				                    <div class="dropdown-divider"></div>
									<a class="dropdown-item reset_password" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-key text-primary"></span> Réinitialiser le mot de passe</a>
				                    <div class="dropdown-divider"></div>

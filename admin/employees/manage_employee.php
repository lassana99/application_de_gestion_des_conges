...
<div class="card card-outline card-primary">
				...
				<div class="row">
					...
					<div class="col-6">
						<div class="form-group">
							...
							<select name="department_id" id="department_id" class="form-control select2bs4 select2 rounded-0" data-placeholder="Choisir le département ici" reqiured>
						...
						<div class="form-group">
							<label for="designation_id">Poste</label>
							<select name="designation_id" id="designation_id" class="form-control select2bs4 select2 rounded-0" data-placeholder="Choisir le poste ici" reqiured>
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary mr-2" form="manage-user">Sauvégarder</button>
					<a class="btn btn-sm btn-secondary" href="./?page=employees">Annuler</a>
				</div>
			</div>
		</div>
</div>

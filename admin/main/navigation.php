...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary text-white bg-lightblue disabled elevation-4 sidebar-no-expand">
        ...
        <img src="<?php echo validate_image($_settings->info('logo'))?>" alt="Store Logo" class="brand-image img-circle elevation-3" style="opacity: .8;width: 3rem;height: 3rem;max-height: unset">
        <span class="brand-text font-weight-light" style="font-size: 1.6rem;"><?php echo $_settings->info('short_name') ?></span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <?php endif; ?>
                    <li class="nav-item dropdown">
                        <a href="<?php echo base_url ?>admin/?page=employees/record_hours" class="nav-link nav-employees_record_hours">
                          <i class="nav-icon fas fa-clock"></i>
                          <p>
                            Enregistrer heures de travail
                          </p>
                        </a>
                      </li>
                      <li class="nav-item dropdown">
                        <a href="<?php echo base_url ?>admin/?page=employees/view_hours" class="nav-link nav-employees_view_hours">
